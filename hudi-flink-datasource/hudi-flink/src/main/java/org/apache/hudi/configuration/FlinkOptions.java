...
public class FlinkOptions extends HoodieConfig {
  ...
  public static final String BUCKET_PARTITIONER_KEY_INDEX_TYPE = "key";
  public static final String BUCKET_PARTITIONER_KEY_PARTITION_INDEX_TYPE = "key_partition";
  public static final ConfigOption<String> BUCKET_INDEX_PARTITIONER_TYPE = ConfigOptions
    .key("hoodie.bucket.index.partitioner.type")
    .stringType()
    .defaultValue(BUCKET_PARTITIONER_KEY_PARTITION_INDEX_TYPE) // default 4 buckets per partition
    .withDescription("The way to partition data to subTask.Can choose [" + BUCKET_PARTITIONER_KEY_INDEX_TYPE +
      "," + BUCKET_PARTITIONER_KEY_PARTITION_INDEX_TYPE + "].");
